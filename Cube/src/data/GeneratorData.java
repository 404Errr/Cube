...
public interface GeneratorData {
	boolean MAKE_PIECES = false, COMPACT = true, HORZ = false;
	...
	int BORING_PLANE_COUNT = (int) (PIECE_SIZE_MAX*0.85f);//(int) (PIECE_SIZE_MAX-(Math.ceil((PIECE_SIZE_MAX-PIECE_SIZE_MIN)/2f)));
